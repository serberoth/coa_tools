...
def register(bl_info):
    ...
    updater.repo = "coa_tools"

    #updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set
    updater.website = "https://github.com/ndee85/coa_tools"
    
    # Addon subfolder path
    updater.subfolder_path = "Blender/coa_tools"
    ...
    updater.include_branch_list = ['blender28']  # is the equivalent to setting ['master']
